program tarefaD
  integer, parameter:: n = 1600, L = 40
  real*8, parameter:: v_0 = 0.4d0, dt = 0.005d0, t_max = 30.0d0
  ...
  open(unit=30, file='temperature.out')
  ...
  do while (t<t_max)
    ...
    if (t>16.0d0) then
      prev_cord = temp - (temp - prev_cord)*1.5d0
    end if

    do i = 1, n
      write(10,*)t, cord(i,1), cord(i,2)
